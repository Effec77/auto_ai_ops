...
coordinates_list = [feature["geometry"]["coordinates"] for feature in geojson_data["features"]]

print("Coordinates from GeoJSON:")
for idx, point in enumerate(coordinates_list):
